...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.shader = ui.Gradient.linear(
        Offset(size.width * 0.4511628, size.height * 0.6114650),
        Offset(size.width * 0.4523256, size.height * -4.458605),
        [Color(0xffDEF9F9).withOpacity(1), Color(0xffFEFEFE).withOpacity(1)],
        [0, 1]);
